...
import { featuredDemonstrativos } from '@/pages/Home';
...
const ShowProducts = () => {
   ...
   const getProducts = async () => {
      const products = await featuredProductService.getAll();
      if (products.data) {
         setFeaturedProdutos(products.data.data);
      }
   };
   ...
   return (
      <>
         <div>
            <h1 className="text-xl text-[#4B4453] font-bold">
               ...
               <table className="w-full text-sm text-left rtl:text-right text-gray-500 ">
                  ...
                  <tbody>
                     {featuredProdutos.length > 0 ? (
                        featuredProdutos?.map((featuredProduto) => (
                           <>
                              <tr
                                 key={featuredProduto._id}
                              ...
                              >
                                 ...
                                 >
                                    {featuredProduto.product.name}
                                 </th>
                                 <td className="px-6 py-4">
                                    R$ {featuredProduto.product.comission}
                                 </td>
                                 <td className="px-6 py-4">ainda não temos</td>
                                 <td className="px-6 py-4">
                                    R$ {featuredProduto.product.price}
                                 </td>
                                 <td className="px-6 py-4">
                                    <a
                                       href="#"
